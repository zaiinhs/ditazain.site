...
const socialMedia: { name: string; icon: ReactNode; url: string }[] = [
  { name: "GitHub", icon: <GithubBrand />, url: "https://github.com/zaiinhs" },
  {
    name: "LinkedIn",
    icon: <LinkedinBrand />,
    url: "https://linkedin.com/in/zaiinhs",
  },
  { name: "X", icon: <XBrand />, url: "https://x.com/zaiinhs" },
  {
    name: "Instagram",
    icon: <InstagramBrand />,
